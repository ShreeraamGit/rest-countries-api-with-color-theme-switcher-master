...
})({"3cSUP":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const controlFilterAndGetValue = async function() {
    ...
    listItemsChild.addEventListener("click", function(e) {
        ...
        _allCountriesViewJsDefault.default._clear();
        const controlFilterData = async function() {
            await _modelJs.loadFilterData(filterValue);
            //console.log(model.state.search.searchresults);
            _modelJs.state.search.searchresults.forEach((element)=>{
                _allCountriesViewJsDefault.default.render(element);
            });
        };
        controlFilterData();
...
const controlSearchResults = async function() {
    try {
        ...
        if (!query) return;
        await _modelJs.loadEachCountryDetail(query);
        //console.log(model.state.countrySelection.selectionResult[0]);
        _searchViewJsDefault.default._clear();
        _allCountriesViewJsDefault.default.render(_modelJs.state.countrySelection.selectionResult[0]);
    } catch (err) {
        console.error(err);
    }
};
...
},{}],"8mcX3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _runtime = require("regenerator-runtime/runtime");
...
const loadFilterData = async function(filterValue) {
    try {
